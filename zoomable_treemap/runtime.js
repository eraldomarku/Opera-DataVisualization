// @observablehq/runtime v5.3.1 Copyright 2022 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
function y(n, a, o, i) {
    ...
    h.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M4 7L0 1h8z' fill='currentColor' />\n  </svg>", h.appendChild(document.createTextNode(`${s}${f?" [":" {"}`)), h.addEventListener("mouseup", (function(e) {
        e.stopPropagation(), ie(p, k(n, null, o, i))
    })), c = c(n);
...
const xe = Ce("d3", "7.7.0", "dist/d3.min.js"),
    ...
    Le = Ce("sql.js", "1.8.0", "dist/sql-wasm.js"),
...
class DuckDBClient {
    ...
    static async of(e = {}, t = {}) {
        ...
        return void 0 === t.query?.castTimestampToDate && (t = {
            ...
            else if (Lt(t)) await async function(e, t, n) {
                const r = (await Rt()).tableFromIPC(n.toArrowBuffer());
...
async function Ft(e, t, n, r) {
    const a = (await Rt()).tableFromJSON(n);
...
function Yt(e, t) {
    var n;
    return (n = Vt.get(e = +e)) ? n.then((() => t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function(e, t) {
...
const Ln = Array.prototype.map;

function Mn() {}
const In = Symbol("no-observer");

function Variable(e, t, n) {
    var r;
    n || (n = In), Object.defineProperties(this, {
        _observer: {
            value: n,
            writable: !0
        },
...
function Bn(e, t, n) {
    ...
    if (this._inputs.forEach(Rn, this), t.forEach(Pn, this), this._inputs = t, this._definition = n, this._value = void 0, n === Mn ? a._variables.delete(this) : a._variables.add(this), e !== this._name || r.get(e) !== this) {
        let t, o;
        if (this._name)
...
Object.defineProperties(Variable.prototype, {
    ...
    define: {
        value: function(e, t, n) {
            ...
            return Bn.call(this, null == e ? null : String(e), null == t ? [] : Ln.call(t, this._module._resolve, this._module), "function" == typeof n ? n : On(n))
        },
        writable: !0,
        configurable: !0
    },
    ...
    import: {
        value: function(e, t, n) {
            ...
            return Bn.call(this, String(t), [n._resolve(String(e))], kn)
        },
        writable: !0,
        configurable: !0
    }
...
Object.defineProperties(Module.prototype, {
            ...
            for (const e of r)
                ...
                for (const [r, a] of t._scope) {
                    ...
                    if (!t || 2 === t._type)
                        ...
                        } else e.define(r, a._inputs.map(Vn), a._definition)
                }
            return i
        },
        writable: !0,
    ...
    value: {
        value: async function(e) {
            ...
            if (!t) throw new RuntimeError(`${e} is not defined`);
            if (t._observer !== In) return Gn(this._runtime, t);
            t = this.variable(!0).define([e], kn);
            try {
                return await Gn(this._runtime, t)
            } finally {
                t.delete()
            }
        },
